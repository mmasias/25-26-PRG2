...
public class ConversorUnidades {
    public static void main(String[] args) {
        ...
        // las dos lineas que corresponden aqui no son necesarias
        int c = 0;
        boolean f = true;
        ...
        if (t == 1) {
           ...
           // en este caso aun que el codigo funcione correctamente puede ser considerado mala práctica, y el estilo que he escogido es mas limpio y ordenado
           switch (o) {
    case 1:
    ...
    default:
        System.out.println("Opcion no valida");
            ...
            if (o == 1) {
                // el error aqui es que al ser numeros enteros anteriormente java elimina los decimales del resultado
        ...
        // aqui es necesario cerrar el scaner declarado arriba
        sc.close();
