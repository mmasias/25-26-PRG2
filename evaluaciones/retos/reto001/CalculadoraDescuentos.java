        ...
        while (true) {
            ...
            while (n_prods < 10) {
                ...
                while (!sc.hasNextDouble()) {
                    sc.nextLine();
                    System.out.print("Precio inválido. Intenta de nuevo: ");
                }
                ...
                while (!sc.hasNextInt()) {
                    sc.nextLine();
                    System.out.print("Cantidad inválida. Intenta de nuevo: ");
                }
            ...
            switch (t) {
                case 1: // Normal
                    if (r == 's') pf -= pf * 0.10;
                    if (c_total >= 5) pf -= pf * 0.05;
                    break;

                case 2: // Estudiante
                    pf -= pf * 0.15;
                    if (r == 's') pf -= pf * 0.10;
                    if (c_total >= 3) pf -= pf * 0.08;
                    break;

                case 3: // Jubilado
                    pf -= pf * 0.20;
                    if (r == 's') pf -= pf * 0.15;
                    if (c_total >= 2) pf -= pf * 0.10;
                    break;

                case 4: // VIP
                    pf -= pf * 0.30;
                    if (r == 's') pf -= pf * 0.20;
                    if (c_total >= 1) pf -= pf * 0.15;
                    break;
            ...
            // Descuento adicional por compras grandes
            if (pf > 500) pf -= 50;

            // Resumen final
            System.out.println("Resumen de Compra");
            System.out.println("Precio original total: " + p_total + " euros");
            System.out.println("Número total de productos: " + c_total);
